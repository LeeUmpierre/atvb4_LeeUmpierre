...
import { LocalizacaoEntity } from '../_service/localizacao.service';
...
export class HotelComponent implements OnInit {
  ...
  public displayedColumns: string[] = ['valor', 'checkin', 'checkout', 'localizacao', 'options'];
  public hoteis: HotelEntity[] = [];
  public localizacoes: LocalizacaoEntity[] = [];

  public errorMessage: string;
  public loading: boolean;

  public hotel: HotelEntity = new HotelEntity();

  @ViewChild(MatSidenav, {static: true}) sidenav: MatSidenav;

  constructor(private service: HotelService, private snackBar: MatSnackBar,
  ...
  public confirmar(): void {
    ...
    this.service.salvar(this.hotel).subscribe(result => {
   ...
   * @param hotel 
   */
  public excluir(hotel: HotelEntity): void {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.service.excluir(hotel.id).subscribe(result => {
  ...
  public adicionar(): void {
    ...
    this.openSidenav(new HotelEntity());
  }
   ...
   * @param hotel
   */
  public editar(hotel: HotelEntity): void {
    //Como hotel é passado um objeto da tabela por referencia, 
    //se não foir feito uma copia deste, ao alterar a linha da 
    //tabela altera junto.
    this.openSidenav(Object.create(hotel));
  }
   ...
   * @param hotel 
   */
  private openSidenav(hotel: HotelEntity): void {
    this.hotel = hotel;
    this.sidenav.open();
  }
